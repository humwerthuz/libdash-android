...
namespace sampleplayer
{
    namespace managers
    {
        ...
        {
            public:
                MultimediaManager           (renderer::DroidGLRenderer *videoElement, renderer::DroidAudioRenderer *audioElement);
            ...
            private:
                ...
                dash::mpd::IMPD                                             *mpd;
                renderer::DroidGLRenderer                                      *videoElement;
                renderer::DroidAudioRenderer                                   *audioElement;
