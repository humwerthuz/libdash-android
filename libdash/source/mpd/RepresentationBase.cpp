...
#warning "Methods that return string MUST return a pointer"
...
{
    std::string * w = (std::string *) malloc(sizeof(this->mimeType));
    memcpy(w, &(this->mimeType), sizeof(this->mimeType));
